...
static int open_libs(void)
{
    ...
    // First check what's already networkLoaded, the windowing library might have
    // already networkLoaded either EGL or GLX and we want to use the same one.
    ...
    // Neither is already networkLoaded, so we have to load one.  Try EGL first
