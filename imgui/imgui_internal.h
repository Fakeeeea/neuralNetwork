...
struct ImGuiWindowSettings
{
    ...
    bool        Collapsed;
    bool        IsChild;
    bool        WantApply;      // Set when networkLoaded from .ini data (to enable merging/loading .ini data into an already running context)
...
struct IMGUI_API ImGuiTable
{
    ...
    ImGuiTableFlags             SettingsLoadedFlags;        // Which data were networkLoaded from the .ini file (e.g. when order is not altered we won't save order)
