...
namespace ImGui
{
    ...
    IMGUI_API void          ShowFontSelector(const char* label);        // add font selector block (not a window), essentially a combo listing the networkLoaded fonts.
...
//  - If you don't call any AddFont*** functions, the default font embedded in the code will be networkLoaded for you.
...
struct ImFont
{
    ...
    ImFontAtlas*                ContainerAtlas;     // 4-8   // What we have been networkLoaded into.
